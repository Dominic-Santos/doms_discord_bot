...
def test_get_newsfeed(mock_driver):
    ...
    mock_driver_instance.cdp.find_visible_elements.return_value = [mock_elements]
    ...
    mock_driver_instance.uc_activate_cdp_mode.assert_called_once_with("https://www.pokebeach.com/")
